...
def initialize_dataframes(params: dict):
...
def append_dataframe(params: dict, state:ArrayLike, date: datetime, df_kep: pd.DataFrame, df_cart: pd.DataFrame):
    if params["outputs"]["Keplerian"]:
...
def process_input(input):
    ...
    date_0, frac_0 = jday(  params["integration"]["start_date"]["year"],
                    ...
                    params["integration"]["start_date"]["second"])
    
    date_f, frac_f  = jday(  params["integration"]["end_date"]["year"],
                    ...
                    params["integration"]["end_date"]["second"])
